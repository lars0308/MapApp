...
export const ROLE_FALLBACK: Partial<Record<TileRole, RoleFallback>> = {
  ...
  floor_corner_top_left: { roles: ['floor_edge_top', 'floor_center'], cats: ['floor'] },
  floor_corner_top_right: { roles: ['floor_edge_top', 'floor_center'], cats: ['floor'] },
  floor_corner_bottom_left: { roles: ['floor_edge_bottom', 'floor_center'], cats: ['floor'] },
  floor_corner_bottom_right: { roles: ['floor_edge_bottom', 'floor_center'], cats: ['floor'] },
