// Example GDScript (Godot 4.3+) that loads a MapForge export and builds TileMapLayer nodes.
// Also shipped as a file in the Godot package export.

export const GODOT_LOADER_FILENAME = 'mapforge_loader.gd';

export const GODOT_LOADER_SCRIPT = `## MapForge → Godot 4 loader (Godot 4.3+, uses TileMapLayer)
##
## Usage:
